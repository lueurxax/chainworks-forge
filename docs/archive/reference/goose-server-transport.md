...
This document is retained only as historical evidence for the removed Goose compatibility layer.
It is not part of the current canonical runtime architecture after Proposal 033.
...
This document was the canonical reference for the Goose compatibility adapter
inside the prior runtime transport stack, including the `GooseServerTransport`
...
- [../../reference/live-provider-execution-slice.md](../../reference/live-provider-execution-slice.md) -- fixture-backed transport baseline
- [../../reference/runtime-contract.md](../../reference/runtime-contract.md)
- [../../reference/acp-runtime-transport.md](../../reference/acp-runtime-transport.md)
- [../../reference/architecture-decisions.md](../../reference/architecture-decisions.md)
- [../../reference/workspace-isolation-risk.md](../../reference/workspace-isolation-risk.md)
...
ACP-native adapters are documented in [../../reference/acp-runtime-transport.md](../../reference/acp-runtime-transport.md).
...
|---|---|---|
| `CHAINWORKS_FIXTURE_MODE` | `proposal_loop_success` to enable fixture backend | (disabled) |
...
When `CHAINWORKS_FIXTURE_MODE=proposal_loop_success` is set, the app
...
| `Chainworks ForgeTests/LiveACPConnectionProofTests.swift` | Historical live connection proof placeholder |
