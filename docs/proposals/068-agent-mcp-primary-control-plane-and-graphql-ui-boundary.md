...
| Depends on | [029-mcp-northbound-control-plane-server.md](029-mcp-northbound-control-plane-server.md), [031-thin-graphql-ui-rewrite.md](031-thin-graphql-ui-rewrite.md), [044-idea-crud-completeness-and-lifecycle-mcp-tools.md](044-idea-crud-completeness-and-lifecycle-mcp-tools.md), [045-run-recovery-and-granular-retry-mcp-tools.md](045-run-recovery-and-granular-retry-mcp-tools.md), [063-mcp-tool-response-shaping-and-field-selection.md](063-mcp-tool-response-shaping-and-field-selection.md), [064-run-worktree-main-sync-and-cross-run-knowledge-transfer.md](064-run-worktree-main-sync-and-cross-run-knowledge-transfer.md), [065-operator-retry-instruction-contract.md](065-operator-retry-instruction-contract.md), [067-lead-decomposed-implementation-slices-and-capability-minimal-agent-routing.md](067-lead-decomposed-implementation-slices-and-capability-minimal-agent-routing.md), [mcp-northbound-control-plane-server.md](../reference/mcp-northbound-control-plane-server.md), [query-projections-and-client-consumption-contract.md](../reference/query-projections-and-client-consumption-contract.md) |
