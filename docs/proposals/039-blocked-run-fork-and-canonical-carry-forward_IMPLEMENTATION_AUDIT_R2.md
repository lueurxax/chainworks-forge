...
Original scope: uncommitted isolated `p039-carry-forward` worktree; main and live
services were not part of the offline audit snapshot. R1 retains the I1 verdict.
