...
| Status | Draft |
| Author | Codex |
| Depends on | [execution-truth-and-recovery.md](../reference/execution-truth-and-recovery.md), [durable side-effect ledger](../reference/rust-control-plane.md#durable-side-effect-ledger), [boundary-first API/auth contract](../reference/boundary-first-api-auth-contract.md) |
