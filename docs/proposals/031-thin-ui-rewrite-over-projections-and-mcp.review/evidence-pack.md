...
| DEP-02 | `docs/reference/p041-generated-artifact-schemas.md`, `docs/reference/test-gates.md#proposal-041p041`, and `docs/proposals/042-local-daemon-lifecycle-supervision-and-packaging.md` | Dependency/reference docs | At review time, P041 and P042 were draft-level prerequisites for parity proof and daemon lifecycle; the server parity harness now has stable schema and gate docs. P031 names them as cutover gates but does not bind concrete gate names or evidence artifacts. |
