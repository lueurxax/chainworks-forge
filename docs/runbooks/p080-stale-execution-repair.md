...
| `hold_reason=permanent_hold_active` | Inspect recent repair events; clear only after root cause is resolved. | `p080.clear_permanent_hold.v1` in Phase 5+ only | platform on-call |
