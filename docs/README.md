...
- [roadmap/2026-08-30-agent-mission-context-and-skills-hardening-program.md](roadmap/2026-08-30-agent-mission-context-and-skills-hardening-program.md) — bounded proposal sequence for deferred Agent Skills and eval hardening
...
- [reference/execution-truth-and-recovery.md](reference/execution-truth-and-recovery.md) — Terminal outcomes, durable execution-truth ownership, command idempotency, shutdown recovery, manual identity holds, atomic transition settlement, cursor-driven resume, recovery precedence, durable side-effect reconciliation, and startup recovery progress
...
- [reference/skill-resolution-and-runtime-integration.md](reference/skill-resolution-and-runtime-integration.md) — Default-on mission context, frozen Agent Skills, copy validation, and runtime injection
...
- [reference/xcode-headless-runtime.md](reference/xcode-headless-runtime.md) - Headless preparation, trusted-project admission, canonical gates, operator diagnostics and production transition
