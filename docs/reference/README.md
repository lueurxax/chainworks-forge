...
- [auto-retry-observation-ledger.md](auto-retry-observation-ledger.md) — P076 observe-only auto-retry ledger, known-issue catalog, MCP readback, rollup tooling, and proof gate
