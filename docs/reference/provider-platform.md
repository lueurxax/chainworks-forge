...
| `SettingsView` System Readiness segment | Operator-facing health summary for the provider/platform slice (formerly `PilotReadinessView`, now under Settings in the consolidated operator shell) |
