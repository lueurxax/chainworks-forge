...
### Phase 4
- Broader non-side-effect catalog adoption remains release-governed. Default-enable decisions use `false_escalation_rate` < 5%, tier success > 0.6, shadow match > 0.95, primary p95 wall-clock regression < 10%, 100% runbook coverage, and P100 live evidence.
