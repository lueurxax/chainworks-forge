...
Fixture: cancelled-or-blocked-run
...
```bash
./scripts/parity/capture-golden-run.sh cancelled-or-blocked-run --record --author "p041-initial-fixture-lifecycle" --reason "Initial checked-in P041 V1 fixture capture baseline"
```
