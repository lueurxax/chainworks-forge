...
Fixture: terminal-report-evidence
...
```bash
./scripts/parity/capture-golden-run.sh terminal-report-evidence --record --author "p041-initial-fixture-lifecycle" --reason "Initial checked-in P041 V1 fixture capture baseline"
```
