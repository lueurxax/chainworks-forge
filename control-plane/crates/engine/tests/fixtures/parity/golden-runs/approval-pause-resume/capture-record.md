...
```bash
./scripts/parity/capture-golden-run.sh approval-pause-resume --record --author "p041-initial-fixture-lifecycle" --reason "Initial checked-in P041 V1 fixture capture baseline"
```
