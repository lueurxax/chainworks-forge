...
```bash
./scripts/parity/capture-golden-run.sh proposal-loop-basic --record --author "p041-initial-fixture-lifecycle" --reason "Initial checked-in P041 V1 fixture capture baseline"
```
