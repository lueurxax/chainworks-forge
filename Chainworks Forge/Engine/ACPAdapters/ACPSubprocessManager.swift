...
nonisolated final class ACPSubprocessManager: @unchecked Sendable {
    ...
    func launch() throws {
        ...
        // Inherit current environment and merge custom environment variables.
    ...
    func sendJSON(_ message: [String: Any]) throws {
        let (running, pipe) = withLock {
            (process?.isRunning ?? false, stdinPipe)
        }
