...
struct Proposal029Tests {
    ...
    // MARK: - Test 2: Swift app does not own live ACP execution

    @Test("Transport factory rejects live ACP families in the app process")
    func factoryRejectsLiveACPFamilies() throws {
        let factory = DefaultRuntimeTransportFactory(fixtureTransport: nil)
        let agent = ResolvedAgent(
            id: "test_agent",
            title: "Test Agent",
    ...
    // MARK: - Test 4: effectiveRuntimeNamespace includes second-wave families
    ...
    // MARK: - Test 5: ProviderCapabilities.satisfies maps tokens correctly
    ...
    // MARK: - Test 6: preferredProvider filters disabled providers
